const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-07-20', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '产品经理',
  HEO_HERO_TITLE_2: '的学习专区',
  HEO_HERO_TITLE_3: 'gri.wang.com',
  HEO_HERO_TITLE_4: '官网上线',
  HEO_HERO_TITLE_5: '前往PM成长研究所',
  HEO_HERO_TITLE_LINK: 'https://www.pmstudy.site',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '摸摸鱼',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '产品入门', url: '/tag/产品入门' },
  HEO_HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HEO_HERO_CATEGORY_3: { title: '面试干货', url: '/tag/面试干货' },
